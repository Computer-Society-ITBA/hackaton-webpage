...
const Mentor = ({ mentor, ...extendedProps }) => {
  const revealed = mentor.revealed === undefined ? true : mentor.revealed;
            ...
            >
              ...
              >
                ...
                <ModalContent backgroundColor="#14192D" borderWidth="2px">
                  <ModalHeader>
                    <HStack>
                      <Heading fontSize={HeadingSize}>{mentor.name}</Heading>
                      <Spacer></Spacer>
                      <IconButton
                        onClick={closeModal}
                        icon={<CloseIcon />}
                  ...
                  <ModalBody p={0}>
                    <VStack>
                      {mentor.details && (
                        ...
                        >
                          {mentor.details.map((detail, index) => (
