...
`
//TODO: change emails
const confirmationEmail = `   <div style="text-align: center; background-color: #1c1c1c; padding: 40px;">
<span style="font-size: 18pt;">
  <span style="font-size: 18pt;">
    <strong>
      <span style="color: #ffffff;">¡Inscripción recibida! 
...
<h3 style="text-align: justify;" align="middle">
  <span style="font-family: arial, helvetica, sans-serif; font-size: 12pt;">
    <br>
    <span style="color: #ffffff;">¡Te aceptaron! En los próximos días te volveremos a contactar para notificarte si fuiste seleccionado dentro de los 25 equipos de la competencia. En caso de ser seleccionado, te pediremos que completes información adicional y elijas tu categoría de preferencia.</span>
  </span> 
  <br>
  <br>
  <span style="color: #ffffff;">
...
`
const rejectionEmail = `   <div style="text-align: center; background-color: #1c1c1c; padding: 40px;">
<span style="font-size: 18pt;">
  <span style="font-size: 18pt;">
    <strong>
      <span style="color: #ffffff;">¡Inscripción recibida! 
...
<h3 style="text-align: justify;" align="middle">
  <span style="font-family: arial, helvetica, sans-serif; font-size: 12pt;">
    <br>
    <span style="color: #ffffff;">¡Te rechazaron! En los próximos días te volveremos a contactar para notificarte si fuiste seleccionado dentro de los 25 equipos de la competencia. En caso de ser seleccionado, te pediremos que completes información adicional y elijas tu categoría de preferencia.</span>
  </span> 
  <br>
  <br>
  <span style="color: #ffffff;">
