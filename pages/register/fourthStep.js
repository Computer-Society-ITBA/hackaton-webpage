    ...
    <VStack>
      <Breadcrumb separator={">"} w='full' padding={'2%'} fontSize = "3xl">
        ...
        <VStack w={"full"} align={"center"} paddingLeft={"2%"}>
          ...
          <Text fontSize={["sm", "md", "lg"]} paddingTop={"2%"}>Recordá que todas las identidades serán corroboradas con foto del DNI</Text>
